...
function Navigation() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 bg-dark-800/95 backdrop-blur-lg border-t border-white/10 z-40 nav-landscape"
        ...
        {tabs.map(({ path, icon: Icon, label }) => {
          ...
          return (
            <button
              ...
              className={`nav-tab-btn relative flex flex-col items-center justify-center min-w-[64px] min-h-[56px] rounded-2xl transition-all active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-neon-cyan focus-visible:ring-offset-2 focus-visible:ring-offset-dark-800 ${
                isActive
            ...
            >
              ...
              />
              <span className={`nav-tab-label text-[10px] font-medium mt-0.5 ${isActive ? 'font-bold' : ''}`}>
                {label}
              </span>
              {isActive && (
